...
<html>
<head>
<title>Grocery Store a Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template | Payment </title>
<!-- for-mobile-apps -->
        ...
        <div id="parentHorizontalTab">
            ...
            <div class="resp-tabs-container hor_1">
				...
				<div>
								...
								<a class="btn btn-outline-success" href="<?=base_url()?>index.php/My_controller/addOrderCOD">Place order</a>
                </div>
                <div>
                    <form action="<?=base_url()?>index.php/My_controller/addOrderCard" method="post" class="creditly-card-form agileinfo_form">
									<section class="creditly-wrapper wthree, w3_agileits_wrapper">
										<div class="credit-card-wrapper">
											<div class="first-row form-group">
												<div class="controls">
													<label class="control-label">Name on Card</label>
													<input class="billing-address-name form-control" type="text" required name="name" placeholder="John Smith">
												</div>
												<div class="w3_agileits_card_number_grids">
													<div class="w3_agileits_card_number_grid_left">
														<div class="controls">
															<label class="control-label">Card Number</label>
															<input class="number credit-card-number form-control" type="text" required name="number"
													...
													<div class="w3_agileits_card_number_grid_right">
														<div class="controls">
															...
															<input class="security-code form-control"Â·
																		  inputmode="numeric"
																		  type="text" required name="security-code"
																		  placeholder="&#149;&#149;&#149;">
														</div>
													</div>
													<div class="clear"> </div>
											...
											<button type="submit" class="submit"><span>Make payment </span></button>
											<!-- <input type="submit" class="submit" value="Make payment and place order"> -->
										</div>
									</section>
								</form>
...
<!-- credit-card -->
		<!-- <script type="text/javascript" src="<?php echo base_url();?>js/creditly.js"></script>
        <link rel="stylesheet" href="<?php echo base_url();?>css/creditly.css" type="text/css" media="all" />
...
<footer>
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4">
				<h4>100% secure payments</h4>
				<img src="card.png" alt=" " class="img-responsive" /> </div>
			<div class="col-lg-8">
				<h5>Connect with us</h5>
